...
set "$accessKey=MmQwZDE2YjAtYmM1Ny0zMGJkLWE4NzctMzRmYTRjN2IxNTBkIDVlZWIzNzE2NDc4NDUxMGFjYTc2Y2E2MSBVU0VSX0RFRkFVTFRfTkFNRQ"
set "$secretKey=pBfwsPkMaM53hMwnLEBtfnOy7ac0EOnUdNVbXYf2gt8"
...
:: Task info
set "$taskName=CucumberAutomationTask-1"
set "$taskDescription=CucumberAutomationTask"
set "$automationFramework=cucumber"
set "$projectKey=ZS2"
set "$versionName=Version-1.0"

:: Cycle info
set "$cycleName=CucumberCI-1"
